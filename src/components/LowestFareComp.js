...
export const LowestFareComp = () => {
  return (
    <div className="relative h-[80%] px-20 py-20 bg-[#1a63a8]">
      <p className="text-sm text-center text-white">বর্তমান মূল্য </p>
      <p className="text-3xl mt-1 text-center text-white">
      আজকের সর্বনিম্ন ভাড়া
      </p>
        ...
        {LOWEST_FARE_LIST.map((item) => {
          return (
            ...
            >
              ...
              <p className="text-sm">
                <span className="text-gray-400">এখান থেকে শুরু </span>{" "}
                <spn className="text-red-400 font-semibold">{item.price}</spn>
              </p>
              <ButtonYellowComp label={"এখন চেক আউট করুন"} extraStyle={"mt-5"} />
            </div>
          );
        })}
      </div>
